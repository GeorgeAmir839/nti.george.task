...
var MiddlewareService_1 = __importDefault(require("./MiddlewareService"));
var Route = (function () {
    function Route(method, path, action, router) {
        this.middlewares = [];
        this.method = method;
        this.path = path;
        this.action = action;
    ...
    Route.prototype.middleware = function () {
        ...
        middlewares.reverse().forEach(function (middleware) {
            ...
            if (middleware.constructor === String) {
                _callback = MiddlewareService_1.default.get(middleware);
                _this.middlewares.push(_callback);
            }
            ...
            var layer = _this.record.route.stack[0];
            var newLayer = new layer.constructor('/', {}, _callback);
            _this.record.route.stack.unshift(newLayer);
        });
        return this;
    };
    ...
    Route.prototype.startRoute = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var controller, method, _controller, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        controller = this.action[0];
                        method = this.action[1];
                        _controller = new controller(request, response);
                        return [4, _controller[method](request, response)];
                    case 1:
                        res = _a.sent();
